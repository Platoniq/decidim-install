...
1. [Use an automated script to install Decidim in Ubuntu 18.04](script/README.md)<br>Download a BASH script that performs automatically (mostly) all the required steps to install Decidim in Ubuntu 18.04. Use it only in freshly installed systems.
